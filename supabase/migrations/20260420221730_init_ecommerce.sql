...
BEGIN
  ...
  INSERT INTO public.products (id, category_id, name, sku, price_brl, price_usd, image, description, specs, in_stock, featured) VALUES
    ...
    ('d0000000-0000-0000-0000-000000000006'::uuid, cat_cnc, 'Mini Router CNC Desktop M-500', 'RBT-CNC-0500', 25000, 4900, 'https://img.usecurling.com/p/500/500?q=desktop+cnc+machine', 'Solução compacta para prototipagem e pequenas produções.', '{"Potência": "2.2kW", "Área de Trabalho": "600x900mm", "Peso": "150kg"}', true, false)
